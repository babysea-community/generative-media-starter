...
This code applies to Generative Media Starter issues, pull requests, discussions, security reports, maintainer communication, and shared support spaces. It also applies when someone represents the project in public community settings.
